...
MoneyRails.configure do |config|
  ...
  Money.rounding_mode = BigDecimal::ROUND_HALF_EVEN # or ROUND_HALF_UP depending on your preference
  Money.locale_backend = :currency # or :i18n, depending on your needs
end
